...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/HuuLiang/HLTPSDKs'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'HuLiang' => 'Liangola@qq.com' }
  s.source           = { :git => 'https://github.com/HuuLiang/HLTPSDKs.git', :tag => s.version.to_s }
  s.ios.deployment_target = '8.0'

  s.subspec 'Alipay' do |alipay|
    # alipay.source_files        = 'HLTPSDKs/AlipaySDK/**/*'
    ...
    alipay.vendored_frameworks = 'HLTPSDKs/AlipaySDK/AlipaySDK.framework' 
    alipay.resource            = 'HLTPSDKs/AlipaySDK/AlipaySDK.bundle'
  ...
  s.subspec 'Tencent' do |tencent|
    # tencent.source_files        = 'HLTPSDKs/TencentOpenAPI/**/*'
    # tencent.preserve_paths      = 'HLTPSDKs/TencentOpenAPI/**/*.a'
    # tencent.vendored_libraries  = 'HLTPSDKs/TencentOpenAPI/**/*.a'
    tencent.vendored_frameworks = 'HLTPSDKs/TencentOpenAPI/TencentOpenAPI.framework'
    tencent.resource            = 'HLTPSDKs/TencentOpenAPI/TencentOpenApi_IOS_Bundle.bundle'
